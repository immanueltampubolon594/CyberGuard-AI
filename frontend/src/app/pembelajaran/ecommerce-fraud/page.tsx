  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-300 font-sans">
      <div className="flex">
        ...
        {/* ── SIDEBAR ── */}
        <aside className="fixed left-0 top-20 w-72 h-[calc(100vh-5rem)] border-r border-slate-800/60 px-6 py-8 hidden lg:flex flex-col bg-[#020617] z-10 overflow-y-auto">
          ...
          <div className="flex items-center gap-1.5 text-[10px] font-bold text-slate-600 mb-6 uppercase tracking-widest">
            ...
            <span className="text-blue-500">E-Commerce Fraud</span>
          </div>
        ...
        <main className="flex-1 lg:ml-72 min-h-screen">
          ...
          {/* Top bar */}
          <div className="sticky top-0 z-10 border-b border-slate-800/60 bg-[#020617]/95 backdrop-blur px-8 lg:px-16 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold text-slate-300">{t?.subtitle}</span>
            </div>
          ...
          <div className="px-8 lg:px-12 xl:px-16 py-12 w-full max-w-none">
            ...
            {/* Page title */}
            <div className="mb-10">
              <p className="text-blue-500 text-[11px] font-black tracking-[6px] uppercase mb-3">E-Commerce Fraud</p>
            ...
            <div className="space-y-12 max-w-8xl">
              ...
              <div className="mt-16 pt-8 border-t border-slate-800/60 flex items-center justify-between">
                <button
                  ...
                  className={`flex items-center gap-3 text-[13px] font-black uppercase tracking-wider text-slate-500 hover:text-white transition-colors ${activeTier === 0 ? "invisible" : ""}`}
                >
